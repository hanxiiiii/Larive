...
<div  id="topMenu" style="border:1px solid black;"  > 
   <ul> 
      ...
      <li><a href="home.jsp"><img src="/pension0503/images/LA RIVE.png"></a></li>
      <li class="topMenuLi">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
      </li> 
      <li class="topMenuLi">|</li> 
      
      <li class="topMenuLi">
         <a class="menuLink" href="">RESERVE</a> 
      </li> 
      <li class="topMenuLi">|</li> 
      <li class="topMenuLi">&nbsp;&nbsp;&nbsp;&nbsp;
      </li> 
      <li class="topMenuLi"> <a class="menuLink" href="/pension0503/roomIndex.jsp">ROOM</a> 
         <ul class="submenu"> 
            <li><a href="roomIndex.jsp" class="submenuLink">방 정보</a></li> 
            <li><a href="" class="submenuLink">찾아오는 길</a></li> 
         </ul>
      </li> 
      <li class="topMenuLi">|</li> 
	  <li class="topMenuLi">&nbsp;&nbsp;&nbsp;&nbsp;
	  </li> 
	  <li class="topMenuLi"> <a class="menuLink" href="roomIndex.jsp">COMMUNITY</a> 
			<ul class="submenu"> 
				<li><a href="roomIndex.jsp" class="submenuLink">리뷰</a></li> 
				<li><a href="" class="submenuLink">외부 블로그 리뷰</a></li> 
			</ul>
		</li> 
      ...
      <li class="topMenuLi"> <a class="menuLink" href="">SURROUNDINGS</a> 
         <ul class="submenu"> 
      ...
      <li class="topMenuLi"> <a class="menuLink" href="">MY PAGE</a> 
         <ul class="submenu"> 
            ...
            <li><a href="" class="submenuLink">예약확인/취소페이지</a></li> 
         </ul>
      </li> 
      <li class="topMenuLi">&nbsp;&nbsp;&nbsp;&nbsp;
      </li> 
      ...
      <li class="topMenuLi"> <a class="menuLink" href="login.jsp">LOGIN</a> 
      </li> 
      <li class="topMenuLi">&nbsp;&nbsp;&nbsp;&nbsp;
      </li> 
      <li class="topMenuLi">|</li> 
      <li class="topMenuLi">&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
         <div class="overlay-content">
            ...
            <a href="roomIndex.jsp">ROOM</a>
            <a href="roomIndex.jsp">COMMUNITY</a>
            <a href="gym.html">SURROUNDINGS</a>
            <a href="class.html">MY PAGE</a>
