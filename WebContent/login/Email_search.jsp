...
<div class="mb-5"> 
    <div class="mb-5">   
   	...
   	<form name="pkc" method="post" action="Email_search_ok.jsp" onsubmit="return logcheck();">
	...
	%>   	
  	...
  	class="form-control" name="Phone" placeholder="Phone" maxlength="13"></td>
   	...
   	<tr>
   	<td align="center"><input type="submit" class="btn btn-outline-secondary" style="width:150px;" value="아이디찾기"></td>
   	</tr> 
    </table>
    </form>
    </div>
